...
--
-- Host: localhost    Database: bimbel_pintar
-- ------------------------------------------------------
...
(1,'admin','admin123','2026-06-28 12:52:48');
...
(1,'test','087955162','SMA','Modul Cetak Khusus, Akses Tryout CBT','Intensif UTBK','ya','2026-06-28 13:47:17');
...
CREATE TABLE `testimoni` (
  ...
  `testimoni_text` text NOT NULL,
  `asal` varchar(100) NOT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `pendaftar_id` (`pendaftar_id`),
  CONSTRAINT `1` FOREIGN KEY (`pendaftar_id`) REFERENCES `pendaftar` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'bimbel_pintar'
--
...
-- Dump completed on 2026-06-29 15:32:10
